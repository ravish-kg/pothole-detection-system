...
public class Maps_Services extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMarkerDragListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps__services);
    ...
    private String getUrl(LatLng origin, LatLng dest) {
        ...
        // Origin of route
        String str_origin = "origin=" + -33.9046 + "," + 151.155;

        // Destination of route
        String str_dest = "destination=" + -33.8291 + "," + 151.248;
